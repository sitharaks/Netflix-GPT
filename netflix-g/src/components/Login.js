  ...
  return (
    <div>
      ...
      <div className='absolute' >
          <img className="h-screen md:h-auto object-cover"src={BACKGROUND_IMAGE} alt="Netflix Logo"  />
      </div>
      <form onSubmit={(e)=>e.preventDefault()} className="w-full md:w-3/12 absolute p-12 bg-black mx-auto my-200 right-0 left-0 text-white rounded-lg bg-opacity-80">
